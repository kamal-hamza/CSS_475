    ...
    return (
        <Container maxWidth="xl" sx={{ py: 4 }}>
            ...
            {loading ? (
                ...
                <Paper elevation={0} sx={{ p: 6, textAlign: "center", border: '1px solid rgba(239, 68, 68, 0.2)', bgcolor: 'rgba(239, 68, 68, 0.05)' }}>
                        ...
                        <Grid container spacing={3}>
                            {sortedTeams.map((team, index) => {
                                const passPercentage =
                                    (team.pass_yards /
                                        (team.pass_yards + team.rush_yards)) *
                                    100;
                                            ...
                                            <CardContent>
                                                ...
                                                <Box sx={{ mb: 3 }}>
                                                    ...
                                                    <Typography
                                                        ...
                                                        color="primary.light"
                                                    >
                                                        {team.total_fantasy_points.toFixed(
                                                            0,
                                                        )}
                                                    </Typography>
                                                </Box>
