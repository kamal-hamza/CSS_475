...
const PlayerProfile = () => {
    ...
    const totalReceivingTDs = stats.reduce(
        (sum, s) => sum + s.receiving_tds,
        0,
    );
    const totalReceptions = stats.reduce((sum, s) => sum + s.receptions, 0);
    const totalInterceptions = stats.reduce(
        (sum, s) => sum + s.interceptions,
        0,
    );
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                <Typography
                                    ...
                                    sx={{ mt: 1 }}
                                >
                                    This player may not have recorded any stats
                                    in the 2024 season yet.
                                </Typography>
                            </Card>
                        </Grid>
                    )}
