...
const PlayerProfile = () => {
  ...
  const totalTDs = stats.reduce(
    (sum, s) =>
      sum + s.passing_tds + s.rushing_tds + s.receiving_tds,
    0,
  );
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3}>
          <Card elevation={0} sx={{ bgcolor: '#131B2F', border: '1px solid rgba(255,255,255,0.05)', height: '100%' }}>
            <CardContent>
            ...
            <TableBody>
              {stats.map((game, i) => (
                ...
                >
                  ...
                  <TableCell align="right" sx={{ color: game.passing_tds > 0 ? 'success.main' : 'inherit' }}>
                    {game.passing_tds}
                  </TableCell>
                  <TableCell align="right">
                    {game.rushing_yards}
                  </TableCell>
                  <TableCell align="right" sx={{ color: game.rushing_tds > 0 ? 'success.main' : 'inherit' }}>
                    {game.rushing_tds}
                  </TableCell>
                  <TableCell align="right">
                    {game.receiving_yards}
                  </TableCell>
                  <TableCell align="right" sx={{ color: game.receiving_tds > 0 ? 'success.main' : 'inherit' }}>
                    {game.receiving_tds}
                  </TableCell>
                  <TableCell
                    align="right"
